...
axis(2, at = seq(0, 300000, 50000), labels = formatC(seq(0, 300000, 50000), digits = 0, format = 'e'))
mtext('Cell Index', side = 1, cex = 0.7)
box()
barplot(as.numeric(GM12878['LTB',]), main = 'LTB', ylab = 'Expression Level (CPM)', border = 'dodgerblue4', yaxt = 'n', ylim = c(0,13000))
axis(2, at = seq(0,12000,5000), labels = formatC(seq(0, 12000,5000), digits = 0, format = 'e'))
mtext('Cell Index', side = 1, cex = 0.7)
box()
barplot(as.numeric(GM12878['RPL17',]), main = 'RPL17', ylab = 'Expression Level (CPM)')
mtext('Cell Index', side = 1, cex = 0.7)
box()
barplot(as.numeric(GM12878['CCL3',]), main = 'CCL3', ylab = 'Expression Level (CPM)', border = 'dodgerblue4', ylim = c(0,27000))
mtext('Cell Index', side = 1, cex = 0.7)
box()
barplot(as.numeric(GM12878['FTL',]), main = 'FTL', ylab = 'Expression Level (CPM)', border = 'dodgerblue4', ylim = c(0,64500))
mtext('Cell Index', side = 1, cex = 0.7)
box()
dev.off()
