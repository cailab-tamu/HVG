...
cMatrix <- readMM('../Data/FIBROBLAST2/SRS2769051.mtx')
rownames(cMatrix) <- readLines('../Data/FIBROBLAST2/genes.tsv')
colnames(cMatrix) <- readLines('../Data/FIBROBLAST2/barcodes.tsv')
...
png('../Results/figures/FIBROBLAST2_Jaccard.png', width = 1500, height = 1500, res = 300)
...
write.csv(outHVG, '../Results/hvgList/FIBROBLAST2_HVG.csv')
HVG <- names(HVG)
...
write.csv(GO, file = '../Results/annotations/FIBROBLAST2_GO_UNION.csv')
write.csv(GO2, file = '../Results/annotations/FIBROBLAST2_GO_INTERSECTION.csv')
...
png('../Results/figures/FIBROBLAST2.png', width = 4000, height = 3000, res = 300)
